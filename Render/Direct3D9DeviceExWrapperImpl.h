#ifndef DIRECT3D9_DEVICEEX_WRAPPER_IMPL_H
#define DIRECT3D9_DEVICEEX_WRAPPER_IMPL_H
#include "IDirect3D9DeviceWrapper.h"

class Direct3D9DeviceExWrapperImpl : public IDirect3D9DeviceWrapper
{
public:
	Direct3D9DeviceExWrapperImpl(IDirect3DDevice9Ex* pD3D9DeviceEx);
	virtual ~Direct3D9DeviceExWrapperImpl();
